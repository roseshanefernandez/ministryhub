...
DEBUG = os.getenv("DJANGO_DEBUG_LEVEL", "False") == "True"
...
INSTALLED_APPS = [
    ...
    "ministryhub.apps.MinistryhubConfig",
]
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("DATABASE_PASSWORD", "db_pw"),
...
# Auth redirects
LOGIN_REDIRECT_URL = "/ministryhub/"
